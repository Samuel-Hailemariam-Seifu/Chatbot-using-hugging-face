                ...
                <div className="grid md:grid-cols-4 gap-8">
                  <div className="md:col-span-2">
                    <div className="flex items-center space-x-3 mb-6">
                      ...
                      <span className="text-xl font-semibold">ChatBot Pro</span>
                    </div>
                    <p className="text-gray-300 leading-relaxed max-w-md mb-6">
                      Professional AI assistant for modern teams. Secure, fast, and intelligent conversation platform.
                    </p>
                  ...
                  <div>
                    <h3 className="text-sm font-semibold mb-4 text-gray-400 uppercase tracking-wider">Product</h3>
                  ...
                  <div>
                    <h3 className="text-sm font-semibold mb-4 text-gray-400 uppercase tracking-wider">Support</h3>
                    <ul className="space-y-3">
